...
During the meeting with Yoav, I showed the results of the between tissue analysis using FDR and FSR. There is one more comparison that we want to make: comparing the effect sizes of the tissue term in both linear models. 
...
summary((log2(abs(human_heart_kidney[,2]/human_heart_kidney[,3])) > 5) == TRUE)
...
beta_twofold <- summary((log2(abs(human_heart_kidney[,2]/human_heart_kidney[,3])) > 2) == TRUE)
beta_threefold <- summary((log2(abs(human_heart_kidney[,2]/human_heart_kidney[,3])) > 3) == TRUE)
beta_fivefold <- summary((log2(abs(human_heart_kidney[,2]/human_heart_kidney[,3])) > 5) == TRUE)
...
beta_perm_twofold <- summary((log2(abs(HvCHeart_DE_perm[,1]/HvCHeart_DE_perm[,2])) > 2) == TRUE)
beta_perm_threefold <- summary((log2(abs(HvCHeart_DE_perm[,1]/HvCHeart_DE_perm[,2])) > 3) == TRUE)
beta_perm_fivefold <- summary((log2(abs(HvCHeart_DE_perm[,1]/HvCHeart_DE_perm[,2])) > 5) == TRUE)
